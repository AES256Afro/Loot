...
| Safely extract to the kingdom map | K or Kingdom button; restores the exact entrance hex with no item loss | Focused Kingdom button |
...
The current published M04C workflow evidence is extraction pull-request run `32668382399` and post-merge `main` run `32668433957`; both completed validation, all 111 assertions, runtime smoke, Linux export, and artifact upload with Actions v7 on the hosted runner. The original M04C pull-request run `32668018512` and post-merge run `32668074607` remain historical 109-assertion evidence. M04B pull-request run `32662209688` and post-merge `main` run `32662260267` remain historical 81-assertion evidence. M04A pull-request run `32659691807` and post-merge `main` run `32659740611` remain historical 65-assertion evidence. The earlier 49-assertion crawler run is also historical evidence only.
