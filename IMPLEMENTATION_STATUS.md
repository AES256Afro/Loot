...
| M01 Repository, project, and quality harness | In progress | Local Git repository on `main`, project layout, ignore and formatting rules, helper commands, content validator, 20-assertion test runner, runtime smoke, three export presets, macOS and Windows artifacts, CI workflow, setup and asset-source docs | Fresh-clone proof and first real CI run |
